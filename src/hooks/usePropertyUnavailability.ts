...
export const usePropertyUnavailability = () =>
  ...
  // id: number
  {
    ...
    const fetchUnavilablePrices = useCallback(
      async (startDate: string, endDate: string, id: number) => {
        setLoading(true);
        try {
    ...
    return {
      ...
      fetchUnavilablePrices: fetchUnavilablePrices,
    };
  };
