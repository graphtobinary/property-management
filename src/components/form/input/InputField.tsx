...
const Input: FC<InputProps> = ({
  ...
  if (disabled) {
    ...
    inputClasses += ` bg-transparent text-gray-800 border-gray-300 focus:border-primaryLight focus:ring-primaryLight/20 dark:border-gray-700 dark:text-white/90  dark:focus:border-primaryLight`;
  }
